...
class MergeChannelCond(nn.Module):
  ...
  def __init__(self, embed_dim, kernel_size, resize_method="cubic", padding_mode="circular"):
      ...
      if key.startswith("channel:"):
        ...
        if value.shape[-3:-1] != out_spatial_shape:
          ...
          if self.layer_norm is None:
            ...
            self.layer_norm = nn.LayerNorm(value.shape[1:], device=self.device, dtype=self.dtype)
