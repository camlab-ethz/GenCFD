...
def get_model_args(
  ...
  if args.model_type in ['UNet', 'PreconditionedDenoiser']:
    ...
    args_dict_2d = {
      ...
      'spatial_resolution': spatial_resolution, 'time_cond': time_cond, 'resize_to_shape': args.resize_to_shape,
      ...
      'noise_embed_dim': args.noise_embed_dim, 'output_proj_channels': 128, 
      'input_proj_channels': 128, 'padding_method': args.padding_method,
  ...
  if args.model_type in ['UNet3D', 'PreconditionedDenoiser3D']:
    ...
    args_dict_3d = {
      ...
      'num_channels': (64, 128, 256), 'downsample_ratio': (2, 2, 2), 'num_blocks': args.num_blocks,
...
def get_denoiser_args(
  ...
  denoiser_args = {
    ...
    'time_cond': time_cond,
    'denoiser': denoiser, 'noise_sampling': noise_sampling,
